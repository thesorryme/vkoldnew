...
<!doctype html>
<html lang="ru">
    <link rel="stylesheet" href="html/videos/videos.css">
<head>
        <meta charset="UTF-8">
    ...
    <?if($your){echo"<title> Мои Видеозаписи | В Кентах</title>";}else{echo"<title> Видеозаписи {$rname} {$rsurname} | В Кентах</title>";}?>
    </head>
<body>
<!-- Контейнер --->
...
<!-- Контент -->
<div id="content">
    <div id="all"> <? include 'html/videos/content.php';?></div>
</div>
<!-- Конец Контент -->
