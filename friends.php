...
<!doctype html>
<html lang="ru">
    <link rel="stylesheet" href="html/friends/friends.css">
<head>
        <meta charset="UTF-8">
    ...
    <?if($your){echo"<title> Мои Друзья | В Кентах</title>";}else{echo"<title> Друзья {$rname} {$rsurname} | В Кентах</title>";}?>
    </head>
<body>
<!-- Контейнер --->
...
<!-- Контент -->
<div id="content">
    <div id="all"> <? include 'html/friends/content.php';?></div>
</div>
<!-- Конец Контент -->
