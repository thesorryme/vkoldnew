...
<!doctype html>
<html lang="ru">
<link rel="stylesheet" href="html/apps/apps.css">
<head>
    <meta charset="UTF-8">
    ...
    <?if($your){echo"<title> Мои Приложения | В Кентах</title>";}else{echo"<title> Приложения {$rname} {$rsurname} | В Кентах</title>";}?>
...
<div id="pageContainer">
    ...
    <div id="pageBody">
        ...
        <!-- Контент -->
        <div id="content">
            <div id="all"><? include('html/apps/content.php')?></div>
        </div> <!-- Конец Контент -->
