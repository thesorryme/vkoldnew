...
<!doctype html>
<html lang="ru">
    <link rel="stylesheet" href="html/albums/albums.css">
<head>
        <meta charset="UTF-8">
    ...
    <?if($your){echo"<title> Мои Фотографии | В Кентах</title>";}else{echo"<title> Фотографии {$rname} {$rsurname} | В Кентах</title>";}?>
    </head>
<body>
<!-- Контейнер --->
...
<!-- Контент -->
<div id="content">
    <div id="all"> <? include 'html/albums/content.php';?></div>
</div>
<!-- Конец Контент -->
